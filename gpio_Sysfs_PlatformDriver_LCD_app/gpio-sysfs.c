...
*
*       A custom device tree file - 'am335x-boneblack-lddpractice.dtsi' is
*       used for the hardware information by the kernel during boot time. 
*       The main dts file 'am335x-boneblack.dts' should be modified to include
*       this.
*       
*       Please check 'readme' for steps and commands.
*
* PUBLIC FUNCTIONS :
*
*
...
*       Copyright info:
*
* AUTHOR :    Tarun Chauhan        START DATE : Aug 11, 2024
*
* CHANGES :
*
